...
export function ProductModal({
  ...
  useEffect(() => {
    if (product) {
      setFormData({
        ...
        critical_level: product.critical_level?.toString() || "10",
        pieces_per_sheet: product.pieces_per_sheet?.toString() || "1",
        sheets_per_box: product.sheets_per_box?.toString() || "1",
  ...
  const validateForm = () => {
    ...
    if (isNaN(piecesPerSheet) || piecesPerSheet < 1) {
      newErrors.pieces_per_sheet = "Must be at least 1";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submitData = {
        ...
        critical_level: parseInt(formData.critical_level),
            ...
            parseInt(formData.total_stock) <=
              ...
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 flex items-center gap-2">
                ...
                <div className="text-sm text-orange-800">
                  ...
                  <p>Current stock is at or below the critical level.</p>
                </div>
              </div>
            )}
