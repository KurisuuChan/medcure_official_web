        ...
        <div className="bg-white shadow-xl rounded-lg">
          <div className="px-6 py-8 border-b border-gray-200">
            ...
            <p className="mt-2 text-gray-600">
              Reset your MedCure system to a fresh state. Choose the reset
          ...
          <div className="px-6 py-8">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    ...
                    delete data and cannot be undone. Make sure you have backups
                    if needed.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <p className="text-blue-700 mb-4">
                  Clears browser storage and resets settings. Keeps database
                  data intact. Perfect for development.
                </p>
                <button
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <p className="text-green-700 mb-4">
                  Only clears browser localStorage and sessionStorage. Keeps all
                  database data and settings.
                </p>
                <button
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                ...
                <p className="text-red-700 mb-4">
                  ⚠️ Removes ALL data including database records, storage, and
                  settings. System will be completely empty.
                </p>
                <button
            ...
            <div className="mb-6">
              <label className="flex items-center">
                ...
                <span className="ml-2 text-sm text-gray-700">
                  I understand that complete resets will permanently delete data
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6">
              ...
              <ul className="text-sm text-gray-700 space-y-2">
                <li>
                  <strong>Quick Reset:</strong> Best for development. Clears
                  cache and resets UI state.
                </li>
                <li>
                  <strong>Clear Storage:</strong> Only removes saved preferences
                  and cache data.
                </li>
                <li>
                  <strong>Complete Reset:</strong> Nuclear option. Removes
                  everything including database.
                </li>
                <li>
                  <strong>Reset + Demo:</strong> Complete reset plus adds sample
                  data for testing.
                </li>
              </ul>
            </div>
