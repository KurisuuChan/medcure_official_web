    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="font-semibold text-gray-800">Report Configuration</h3>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
          ...
          {reports.productPerformance && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-center text-sm text-gray-600">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                {reports.productPerformance.summary.productsWithSales} products
                with sales data
              </div>
            </div>
          )}
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-blue-700">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <span>
                    <strong>Performance Insights:</strong> Product profitability
                    & turnover analysis
                  </span>
                </div>
              </div>
