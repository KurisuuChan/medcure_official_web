...
export const ThemeProvider = ({ children }) => {
  ...
  const generateColorVariations = (primaryColor) => {
    ...
    return {
      ...
      primaryColorHover: `#${hoverR.toString(16).padStart(2, "0")}${hoverG
        .toString(16)
        .padStart(2, "0")}${hoverB.toString(16).padStart(2, "0")}`,
      primaryColorLight: `#${lightR.toString(16).padStart(2, "0")}${lightG
        .toString(16)
        .padStart(2, "0")}${lightB.toString(16).padStart(2, "0")}`,
      primaryColorDark: `#${darkR.toString(16).padStart(2, "0")}${darkG
        .toString(16)
  ...
  const applyThemeToDOM = (themeData) => {
    ...
    root.style.setProperty(
      "--base-font-size",
      fontSizeScale[themeData.fontSize] || "16px"
    );
  };
  ...
  const getThemeClasses = () => {
    return {
      ...
      primaryRing:
        "ring-[var(--primary-color)] focus:ring-[var(--primary-color)]",
    };
  };
